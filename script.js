...
async function checarPermissaoMaster() {
    ...
    try {
        ...
        if (perfil === 'administrador' && (status === '' || status === 'aprovado')) return true;
...
function autoFill() {
    ...
    if (val === 'TEMU9295736') {
        ...
        if (tara) tara.value = '4730';
        if (gross) gross.value = '35000';
    }
}
            ...
            let gridHTML = `
                <div class="card" style="padding:10px;">
                    ...
                    <div style="display:grid; grid-template-columns: repeat(7, 1fr); gap: 2px; font-size: 11px; text-align:center;">
                        <div style="font-weight:bold; color:var(--navy);">S</div>
                        <div style="font-weight:bold; color:var(--navy);">T</div>
                        <div style="font-weight:bold; color:var(--navy);">Q</div>
                        <div style="font-weight:bold; color:var(--navy);">Q</div>
                        <div style="font-weight:bold; color:var(--navy);">S</div>
                        <div style="font-weight:bold; color:var(--navy);">S</div>
